...
var Kingdom = exports.Kingdom = function () {
    ...
    function Kingdom() {
        ...
        (0, _classCallCheck3.default)(this, Kingdom);

        if ((typeof subject === "undefined" ? "undefined" : (0, _typeof3.default)(subject)) !== "object" || Array.isArray(subject)) throw new Error("Constructor did not receive the expected type object");
    ...
    (0, _createClass3.default)(Kingdom, [{
        key: "getLord",
        ...
        value: function addSubject(subject, makeLord) {
            if ((typeof subject === "undefined" ? "undefined" : (0, _typeof3.default)(subject)) !== "object" || Array.isArray(subject)) throw new Error("addSubject did not receive the expected type object");
            subject.subjects = subject.subjects || [];
        ...
        value: function findParentOfChild(child, delegateLord) {
            if (!!delegateLord && !!delegateLord.subjects) {
                ...
                try {
                    for (var _iterator = (0, _getIterator3.default)(delegateLord.subjects), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        ...
        value: function setPropertiesAndAttributes(el, prop, attr) {
            ...
            for (var _key in prop) {
                ...
                if ((typeof val === "undefined" ? "undefined" : (0, _typeof3.default)(val)) === 'object' && typeof val !== 'function') this.setPropertiesAndAttributes(el[_key], val);else {
                    el[_key] = val;
                }
            }
        }
